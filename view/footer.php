...
?>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2018-2022 
        <a href="https://adminlte.io">Ashishya11 Studio
        </a>.
      </strong> All rights
      reserved.
    </footer>
          ...
          <ul class="control-sidebar-menu">
            <li>
              <a href="javascript:void(0)">
                <h4 class="control-sidebar-subheading">
                  ...
                  <span class="label label-danger pull-right">70%
                  </span>
                </h4>
            ...
            <li>
              <a href="javascript:void(0)">
                <h4 class="control-sidebar-subheading">
                  Laravel Integration
                  <span class="label label-warning pull-right">50%
                  </span>
                </h4>
                <div class="progress progress-xxs">
            ...
            <li>
              <a href="javascript:void(0)">
                <h4 class="control-sidebar-subheading">
                  Back End Framework
                  <span class="label label-primary pull-right">68%
                  </span>
                </h4>
                <div class="progress progress-xxs">
