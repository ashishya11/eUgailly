                  ...
                  <ul class="menu">
                    <li>
                      ...
                      <a href="#">
                        ...
                        <p>Why are you not buy anything ?
                        </p>
                      </a>
                    </li>
                    <!-- end message -->
          ...
          <li>
            <a href="../pages/mailbox/mailbox.html">
              ...
              <span class="pull-right-container">
                ...
                <small class="label pull-right bg-red">5
                </small>
              </span>
            </a>
          </li>
          <li class="<?php if(isset($calenderActive)) echo 'active';?>">
            <a href="calendar.html">
              ...
              <span class="pull-right-container">
                <small class="label pull-right bg-red">3
                </small>
                <small class="label pull-right bg-blue">17
                </small>
              </span>
            </a>
          </li>
