                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="logout.php" class="btn btn-default btn-flat">Sign out
                      </a>
                    </div>
                  </li>
                </ul>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview <?php if(isset($webActive)) echo 'active';?>">
              <a href="#">
                <i class="fa fa-cog">
                </i> 
                <span>Web-setting
              ...
              <ul class="treeview-menu">
                <li class="<?php if(isset($webActive)) echo 'active';?>">
                    <a href="web_setting.php">
                      <i class="fa fa-circle">
                      </i> Web-setting
                    </a>
                    </li>
